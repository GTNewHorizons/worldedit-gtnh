...
public class WorldEditBinding extends BindingHelper {
    ...
    public EditSession getEditSession(ArgumentStack context) throws ParameterException {
        ...
        context.getContext()
            .getLocals()
            .put(EditSession.class, editSession);
    ...
    public Actor getActor(ArgumentStack context) throws ParameterException {
        Actor sender = context.getContext()
            .getLocals()
            .get(Actor.class);
        if (sender == null) {
    ...
    public BaseBlock getBaseBlock(ArgumentStack context) throws ParameterException, WorldEditException {
        Actor actor = context.getContext()
            .getLocals()
            .get(Actor.class);
        ParserContext parserContext = new ParserContext();
        parserContext.setActor(
            context.getContext()
                .getLocals()
                .get(Actor.class));
        ...
        parserContext.setSession(
            worldEdit.getSessionManager()
                .get(actor));
        try {
            return worldEdit.getBlockFactory()
                .parseFromInput(context.next(), parserContext);
    ...
    public Mask getMask(ArgumentStack context) throws ParameterException, WorldEditException {
        ...
        parserContext.setSession(
            worldEdit.getSessionManager()
                .get(actor));
        try {
            return worldEdit.getMaskFactory()
                .parseFromInput(context.next(), parserContext);
        } catch (NoMatchException e) {
            throw new ParameterException(e.getMessage(), e);
        }
        ...
        if (input != null) {
            ...
            if (type != null) {
                ...
                throw new ParameterException(
                    String.format(
                        "Can't recognize tree type '%s' -- choose from: %s",
                        input,
    ...
    public BaseBiome getBiomeType(ArgumentStack context) throws ParameterException, WorldEditException {
        ...
        if (input != null) {
            ...
            BiomeRegistry biomeRegistry = world.getWorldData()
                .getBiomeRegistry();
