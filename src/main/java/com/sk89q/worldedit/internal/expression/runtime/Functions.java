...
public final class Functions {
    ...
    @Dynamic
    public static double closest(RValue x, RValue y, RValue z, RValue index, RValue count, RValue stride)
    ...
    @Dynamic
    public static double gclosest(RValue x, RValue y, RValue z, RValue index, RValue count, RValue stride)
        throws EvaluationException {
        return findClosest(
            gmegabuf,
            x.getValue(),
    ...
    private static double findClosest(Map<Integer, double[]> megabuf, double x, double y, double z, int index,
    ...
    public static double perlin(RValue seed, RValue x, RValue y, RValue z, RValue frequency, RValue octaves,
        RValue persistence) throws EvaluationException {
    ...
    public static double voronoi(RValue seed, RValue x, RValue y, RValue z, RValue frequency)
        throws EvaluationException {
    ...
    public static double ridgedmulti(RValue seed, RValue x, RValue y, RValue z, RValue frequency, RValue octaves)
        throws EvaluationException {
    ...
    private static double queryInternal(RValue type, RValue data, double typeId, double dataValue)
        throws EvaluationException {
    ...
    public static double query(RValue x, RValue y, RValue z, RValue type, RValue data) throws EvaluationException {
        ...
        final ExpressionEnvironment environment = Expression.getInstance()
            .getEnvironment();
