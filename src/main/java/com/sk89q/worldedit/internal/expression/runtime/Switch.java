...
public class Switch extends Node implements RValue {
    ...
    public Switch(int position, RValue parameter, List<Double> values, List<RValue> caseStatements,
        RValue defaultCase) {
    ...
    private Switch(int position, RValue parameter, Map<Double, Integer> valueMap, List<RValue> caseStatements,
        RValue defaultCase) {
        super(position);
    ...
    public RValue optimize() throws EvaluationException {
        ...
        if (optimizedParameter instanceof Constant) {
            ...
            return new Switch(
                getPosition(),
                optimizedParameter,
                Collections.singletonMap(parameter, 0),
                newSequence,
                null);
        }
