 ...
 */
public class Polygonal2DRegionSelector extends com.sk89q.worldedit.regions.Polygonal2DRegionSelector
    ...
    public void learnChanges() {
        BlockVector2D pt = region.getPoints()
            .get(0);
        pos1 = new BlockVector(
            pt.getBlockX(),
