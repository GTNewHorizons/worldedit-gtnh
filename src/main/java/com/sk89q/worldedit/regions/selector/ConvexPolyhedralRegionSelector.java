 ...
 */
public class ConvexPolyhedralRegionSelector extends com.sk89q.worldedit.regions.ConvexPolyhedralRegionSelector
    ...
    public ConvexPolyhedralRegionSelector(RegionSelector oldSelector) {
        ...
        if (oldSelector instanceof ConvexPolyhedralRegionSelector) {
            ...
            try {
                ...
                region = new ConvexPolyhedralRegion(
                    oldSelector.getIncompleteRegion()
                        .getWorld());
                return;
            }

            final int minY = oldRegion.getMinimumPoint()
                .getBlockY();
            final int maxY = oldRegion.getMaximumPoint()
                .getBlockY();
    ...
    public boolean selectSecondary(Vector position, SelectorLimits limits) {
        ...
        if (vertexLimit.isPresent() && region.getVertices()
            .size() > vertexLimit.get()) {
            return false;
        }
