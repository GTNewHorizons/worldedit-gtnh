 ...
 */
public class EllipsoidRegionSelector extends com.sk89q.worldedit.regions.EllipsoidRegionSelector
    ...
    public EllipsoidRegionSelector(RegionSelector oldSelector) {
        ...
        if (oldSelector instanceof EllipsoidRegionSelector) {
            ...
            BlockVector pos1 = oldRegion.getMinimumPoint()
                .toBlockVector();
            BlockVector pos2 = oldRegion.getMaximumPoint()
                .toBlockVector();
    ...
    public boolean selectPrimary(Vector position, SelectorLimits limits) {
        if (position.equals(region.getCenter()) && region.getRadius()
            .lengthSq() == 0) {
            return false;
        }
    ...
    public boolean isDefined() {
        return started && region.getRadius()
            .lengthSq() > 0;
    }
