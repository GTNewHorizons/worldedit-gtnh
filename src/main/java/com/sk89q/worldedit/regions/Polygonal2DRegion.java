...
public class Polygonal2DRegion extends AbstractRegion implements FlatRegion {
    ...
    protected void recalculate() {
        ...
        int minX = points.get(0)
            .getBlockX();
        int minZ = points.get(0)
            .getBlockZ();
        int maxX = points.get(0)
            .getBlockX();
        int maxZ = points.get(0)
            .getBlockZ();
    ...
    public static boolean contains(List<BlockVector2D> points, int minY, int maxY, Vector pt) {
        ...
        xOld = points.get(npoints - 1)
            .getBlockX();
        zOld = points.get(npoints - 1)
            .getBlockZ();
    ...
    public List<BlockVector2D> polygonize(int maxPoints) {
        if (maxPoints >= 0 && maxPoints < points.size()) {
            throw new IllegalArgumentException(
                "Cannot polygonize a this Polygonal2DRegion into the amount of points given.");
        }
