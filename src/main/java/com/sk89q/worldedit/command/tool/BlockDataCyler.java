...
public class BlockDataCyler implements DoubleActionBlockTool {
    ...
    private boolean handleCycle(Platform server, LocalConfiguration config, Player player, LocalSession session,
        ...
        if (!config.allowedDataCycleBlocks.isEmpty() && !player.hasPermission("worldedit.override.data-cycler")
