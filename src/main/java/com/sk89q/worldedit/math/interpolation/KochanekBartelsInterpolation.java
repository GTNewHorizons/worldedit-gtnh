...
public class KochanekBartelsInterpolation implements Interpolation {
    ...
    private double arcLengthRecursive(int index, double remainderLeft, double remainderRight) {
        ...
        double accum = a.multiply(remainderLeft)
            .add(b)
            .multiply(remainderLeft)
            .add(c)
            .length() / 2.0;
        ...
        accum += a.multiply(remainderRight)
            .add(b)
            .multiply(remainderRight)
            .add(c)
            .length() / 2.0;
