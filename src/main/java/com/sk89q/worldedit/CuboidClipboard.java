...
public class CuboidClipboard {
    ...
    public void rotate2D(int angle) {
        ...
        final BaseBlock[][][] newData = new BaseBlock[Math.abs(sizeRotated.getBlockX())][Math
            .abs(sizeRotated.getBlockY())][Math.abs(sizeRotated.getBlockZ())];
    ...
    public LocalEntity[] pasteEntities(Vector newOrigin) {
        ...
        for (int i = 0; i < this.entities.size(); ++i) {
            ...
            if (copied.entity.spawn(
                copied.entity.getPosition()
                    .setPosition(copied.relativePosition.add(newOrigin)))) {
    ...
    private class CopiedEntity {
        ...
        private CopiedEntity(LocalEntity entity) {
            this.entity = entity;
            this.relativePosition = entity.getPosition()
                .getPosition()
                .subtract(getOrigin());
        }
    }
