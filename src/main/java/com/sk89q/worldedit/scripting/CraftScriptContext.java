...
public class CraftScriptContext extends CraftScriptEnvironment {
    ...
    public CraftScriptContext(WorldEdit controller, Platform server, LocalConfiguration config, LocalSession session,
    ...
    public EditSession remember() {
        EditSession editSession = controller.getEditSessionFactory()
            .getEditSession(player.getWorld(), session.getBlockChangeLimit(), session.getBlockBag(player), player);
     ...
     * @throws FilenameException
     */
    public File getSafeOpenFile(String folder, String filename, String defaultExt, String... exts)
        throws FilenameException {
        File dir = controller.getWorkingDirectoryFile(folder);
     ...
     * @throws FilenameException
     */
    public File getSafeSaveFile(String folder, String filename, String defaultExt, String... exts)
        throws FilenameException {
        File dir = controller.getWorkingDirectoryFile(folder);
