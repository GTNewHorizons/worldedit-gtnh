...
public class ForgePlayer extends AbstractPlayerActor {
    ...
    public WorldVector getPosition() {
        return new WorldVector(
            LocalWorldAdapter.adapt(ForgeWorldEdit.inst.getWorld(this.player.worldObj)),
            this.player.posX,
            this.player.posY,
            this.player.posZ);
    }
    ...
    public void dispatchCUIEvent(CUIEvent event) {
        ...
        S3FPacketCustomPayload packet = new S3FPacketCustomPayload(
            ForgeWorldEdit.CUI_PLUGIN_CHANNEL,
            send.getBytes(WECUIPacketHandler.UTF_8_CHARSET));
    ...
    public boolean hasPermission(String perm) {
        return ForgeWorldEdit.inst.getPermissionsProvider()
    ...
    private static class SessionKeyImpl implements SessionKey {
        ...
        public boolean isActive() {
            ...
            return ThreadSafeCache.getInstance()
                .getOnlineIds()
                .contains(uuid);
        }
