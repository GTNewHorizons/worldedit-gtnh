...
public class EditSessionFactory {
     ...
     * @param maxBlocks the maximum number of blocks that can be changed, or -1 to use no limit
     * @return an instance
     * @deprecated We are replacing {@link LocalWorld} with {@link World}, so use {@link #getEditSession(World, int)}
     *             instead
     */
    @Deprecated
     ...
     * @param player    the player that the {@link EditSession} is for
     * @return an instance
     * @deprecated We are replacing {@link LocalWorld} with {@link World}, so use
     *             {@link #getEditSession(World, int, Player)} instead
     */
    @Deprecated
     ...
     * @return an instance
     * @deprecated We are replacing {@link LocalWorld} with {@link World}, so use
     *             {@link #getEditSession(World, int, BlockBag)} instead
     */
    @Deprecated
     ...
     * @return an instance
     * @deprecated We are replacing {@link LocalWorld} with {@link World}, so use
     *             {@link #getEditSession(World, int, BlockBag, Player)} instead
     */
    @Deprecated
