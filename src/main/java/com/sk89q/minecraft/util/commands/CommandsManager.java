...
public abstract class CommandsManager<T> {
    ...
    public boolean hasCommand(String command) {
        return commands.get(null)
            .containsKey(command.toLowerCase());
    }
    ...
    public void executeMethod(Method parent, String[] args, T player, Object[] methodArgs, int level)
        ...
        // - /cmd <arg1> - @NestedCommand(executeBody = false) will always go to the nested command class not matter the
        // args
        boolean executeNested = method.isAnnotationPresent(NestedCommand.class)
            && (argsCount > 0 || !method.getAnnotation(NestedCommand.class)
                .executeBody());
    ...
    public void invokeMethod(Method parent, String[] args, T player, Method method, Object instance,
