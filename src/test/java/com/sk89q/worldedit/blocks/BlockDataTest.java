...
public class BlockDataTest {
    ...
    public void testRotateFlip() {
        for (int type = 0; type < 256; ++type) {
            for (int data = 0; data < 16; ++data) {
                ...
                final int flipped = BlockData
                    .flip(type, BlockData.flip(type, data, FlipDirection.WEST_EAST), FlipDirection.NORTH_SOUTH);
                ...
                assertEquals(
                    ...
                    data,
                    BlockData
                        .flip(type, BlockData.flip(type, data, FlipDirection.NORTH_SOUTH), FlipDirection.NORTH_SOUTH));
                // Test flipWE(flipWE(x))==x
                assertEquals(
                    message,
                    data,
                    BlockData.flip(type, BlockData.flip(type, data, FlipDirection.WEST_EAST), FlipDirection.WEST_EAST));
                // Test flipUD(flipUD(x))==x
                assertEquals(
                    message,
                    data,
                    BlockData.flip(type, BlockData.flip(type, data, FlipDirection.UP_DOWN), FlipDirection.UP_DOWN));
                ...
                assertEquals(
                    ...
                    BlockData.rotate90(
                        type,
                        BlockData.rotate90(type, BlockData.rotate90(type, BlockData.rotate90(type, data)))));
                // Test r-90(r-90(r-90(r-90(x))))==x
                assertEquals(
                    message,
                    data,
                    BlockData.rotate90Reverse(
                        type,
                        BlockData.rotate90Reverse(
                            type,
                            BlockData.rotate90Reverse(type, BlockData.rotate90Reverse(type, data)))));
            }
        }
    }
    ...
    public void testCycle() {
        ...
        for (int type = 0; type < 256; ++type) {
            ...
            if (type == BlockID.CLOTH || type == BlockID.STAINED_CLAY
